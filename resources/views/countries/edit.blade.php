        ...
        <div class="card mx-auto" style="width: 100%;">
            <div class="card-header">{{ __('Create Country') }}
                <form action="{{ route('countries.destroy', $country->id) }}" method="post">
                    @csrf
                    @method('DELETE')
                    <button class="float-right btn btn-danger" title="Delete {{ $country->name }}"><i
                            class="fa fa-trash fa-fw"></i></button>
                </form>
                <a href="{{ route('countries.index') }}" class="btn btn-primary float-right mx-2">Back</a>
            </div>
            <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="country_code" type="text"
                                ...
                                placeholder="Input Your Country Code" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                ...
                                placeholder="Input Your Country Name" required autocomplete="name" autofocus>
